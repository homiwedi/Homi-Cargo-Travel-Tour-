...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
    ...
    .profile-box { display: flex; align-items: center; gap: 1.5rem; background: #eef4f8; padding: 1.25rem; border-radius: 8px; margin-bottom: 1.5rem; flex-wrap: wrap; }
    .profile-img { width: 130px; height: 130px; border-radius: 50%; object-fit: cover; border: 3px solid #ffcc00; box-shadow: 0 4px 8px rgba(0,0,0,0.15); }
    .video-card { background: #002244; color: white; border-radius: 8px; overflow: hidden; padding: 1rem; text-align: center; }
    .video-card h4 { color: #ffcc00; margin-bottom: 0.5rem; font-size: 1.05rem; }
    .video-card video { width: 100%; max-height: 240px; border-radius: 6px; background: #000; margin-bottom: 0.5rem; }
...
<body>
  ...
  <header>
    ...
    <nav>
      ...
      <a href="#gallery" data-i18n="nav_gallery">Media & Proof</a>
  ...
  <div class="container">
    ...
    <section class="page-section">
      <div class="profile-box">
        <img src="20250531_124703.jpg" alt="Homi - Travel Agent" class="profile-img">
        <div>
          <h3 style="color: #003366;" data-i18n="profile_title">Meet Your Agent & Travel Partner</h3>
          <p style="font-size: 0.95rem; color: #444;" data-i18n="profile_desc">Providing personal, trusted service for Habesha communities and international travelers in Kampala. Contact me directly for flight tickets, air cargo to Eritrea 🇪🇷, and visa guidance.</p>
        </div>
      </div>
    ...
    <!-- NEW SECTION: CLIENT SUCCESS & VIDEO GALLERY -->
    <section id="gallery" class="page-section">
      <h2 data-i18n="gallery_section_title">📹 Client Success & Video Proof</h2>
      <p data-i18n="gallery_section_desc">See real moments from our satisfied clients receiving visas, cargo in Asmara 🇪🇷, and buying tickets at our Kampala office.</p>
      
      <div class="grid-3">
        <!-- Video 1: Visa Success -->
        <div class="video-card">
          <h4 data-i18n="vid_visa_title">📜 Habesha Clients Receiving Visas</h4>
          <video controls poster="https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=400&q=80">
            <source src="visa_success.mp4" type="video/mp4">
            Your browser does not support the video tag.
          </video>
          <p style="font-size: 0.85rem; color: #cbd5e1;" data-i18n="vid_visa_desc">Happy clients receiving their approved travel documents.</p>
        </div>

        <!-- Video 2: Cargo Delivery in Asmara -->
        <div class="video-card">
          <h4 data-i18n="vid_cargo_title">📦 Delivery in Asmara, Eritrea 🇪🇷</h4>
          <video controls poster="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=400&q=80">
            <source src="asmara_cargo.mp4" type="video/mp4">
            Your browser does not support the video tag.
          </video>
          <p style="font-size: 0.85rem; color: #cbd5e1;" data-i18n="vid_cargo_desc">Clients safely receiving air cargo in Asmara with the Eritrean flag 🇪🇷.</p>
        </div>

        <!-- Video 3: Ticket Purchases -->
        <div class="video-card">
          <h4 data-i18n="vid_ticket_title">✈️ Ticket Purchases at Our Office</h4>
          <video controls poster="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=400&q=80">
            <source src="ticket_buying.mp4" type="video/mp4">
            Your browser does not support the video tag.
          </video>
          <p style="font-size: 0.85rem; color: #cbd5e1;" data-i18n="vid_ticket_desc">In-person flight bookings and ticket handovers in Kampala.</p>
        </div>
      </div>
    </section>
    ...
    <section id="cargo" class="page-section">
      ...
      <div class="card" style="background: #e6f0fa; border: 2px solid #003366; text-align: center; padding: 2rem; margin-top: 1rem;">
        <h3 style="font-size: 1.6rem; color: #003366;" data-i18n="cargo_rate_title">Air Cargo Freight Rate to Asmara 🇪🇷</h3>
  ...
  <script>
    const translations = {
      en: {
        ...
        profile_title: "Meet Your Agent & Travel Partner",
        profile_desc: "Providing personal, trusted service for Habesha communities and international travelers in Kampala. Contact me directly for flight tickets, air cargo to Eritrea 🇪🇷, and visa guidance.",
        ...
        gallery_section_title: "📹 Client Success & Video Proof",
        gallery_section_desc: "See real moments from our satisfied clients receiving visas, cargo in Asmara 🇪🇷, and buying tickets at our Kampala office.",
        vid_visa_title: "📜 Habesha Clients Receiving Visas",
        vid_visa_desc: "Happy clients receiving their approved travel documents.",
        vid_cargo_title: "📦 Delivery in Asmara, Eritrea 🇪🇷",
        vid_cargo_desc: "Clients safely receiving air cargo in Asmara with the Eritrean flag 🇪🇷.",
        vid_ticket_title: "✈️ Ticket Purchases at Our Office",
        vid_ticket_desc: "In-person flight bookings and ticket handovers in Kampala.",
        ...
        cargo_rate_title: "Air Cargo Freight Rate to Asmara 🇪🇷",
      ...
      ti: {
        ...
        profile_title: "ናይ ጉዕዞ ኣማኻሪኹም",
        profile_desc: "ንሕብረተሰብ ሓበሻን ንመገደስቲ ዓለምን ኣብ ካምፓላ እሙን ኣገልግሎት ንህብ። ብዛዕባ ትኬት ነፋሪት፣ ናብ ኤርትራ 🇪🇷 ዝልኣኽ ካርጎን ናይ ቪዛ ሓበሬታን ብቐጥታ ኣነጋግሩና።",
        ...
        card_rentals_desc: "እሙናት መካይን ንከተማ፣ ምቕባል ካብ ኤርፖርት፣ ናይ ቱሪዝም ጉዕዞታት።",
        gallery_section_title: "📹 ናይ ዓማቪልና ቪዲዮታትን መርትዖን",
        gallery_section_desc: "ዓማቪልና ቪዛ እንከረክቡ፣ ካርጎ ኣብ ኣስመራ 🇪🇷 እንክቕበሉን ትኬት ኣብ ቤት ጽሕፈትና እንክቖርጹን ዝርኣዩሉ ቪዲዮታት።",
        vid_visa_title: "📜 ዓማቪልና ቪዛ እንክቕበሉ",
        vid_visa_desc: "ሕጉሳት ዓማቪልና ዝተፈቐደሎም ናይ ጉዕዞ ሰነዳት እንክቕበሉ።",
        vid_cargo_title: "📦 ምርክብ ካርጎ ኣብ ኣስመራ 🇪🇷",
        vid_cargo_desc: "ዓማቪልና ኣብ ኣስመራ ምስ ሰንደቕ ዓላማ ኤርትራ 🇪🇷 ካርጎኦም እንክቕበሉ።",
        vid_ticket_title: "✈️ ምቁራጽ ትኬት ኣብ ቤት ጽሕፈትና",
        vid_ticket_desc: "ኣብ ካምፓላ ኣብ ዘሎ ቤት ጽሕፈትና ትኬት እንክቖርጹ።",
        ...
        cargo_rate_title: "ናይ ኣየር ካርጎ ዋጋ ናብ ኣስመራ 🇪🇷",
      ...
      fr: {
        ...
        profile_title: "Rencontrez Votre Agent de Voyage",
        profile_desc: "Un service de confiance pour les communautés Habesha et les voyageurs internationaux à Kampala. Contactez-moi directement pour vos billets, le fret vers l'Érythrée 🇪🇷 et les visas.",
        ...
        gallery_section_title: "📹 Preuves Vidéos Nos Clients",
        gallery_section_desc: "Découvrez nos clients recevant leurs visas, leur fret à Asmara 🇪🇷 et achetant leurs billets à notre bureau de Kampala.",
        vid_visa_title: "📜 Clients Recevant Leurs Visas",
        vid_visa_desc: "Clients satisfaits recevant leurs documents de voyage approuvés.",
        vid_cargo_title: "📦 Livraison à Asmara, Érythrée 🇪🇷",
        vid_cargo_desc: "Réception sécurisée du fret aérien à Asmara avec le drapeau érythréen 🇪🇷.",
        vid_ticket_title: "✈️ Achat de Billets au Bureau",
        vid_ticket_desc: "Réservations en personne et remise de billets à Kampala.",
        ...
        cargo_rate_title: "Tarif du Fret Aérien vers Asmara 🇪🇷",
